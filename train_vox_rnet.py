...
from util.vox_util import three_view_with_heatmap
...
def main(args):
    ...
    '''train_loader = torch.utils.data.DataLoader(
        datasets.Fish_Vox('/mnt/gypsum/mnt/nfs/work1/kalo/zhanxu/shark_pose_dataset/3d_data/fish_vox_annotations_trainval_64.json',
                          '/mnt/gypsum/mnt/nfs/work1/kalo/zhanxu/shark_pose_dataset/3d_data',
                          '/mnt/gypsum/mnt/nfs/work1/kalo/zhanxu/shark_pose_dataset/3d_data/voxel/trainval_64_thin',
                          sigma=args.sigma),
    ...
    for i, (inputs, target, meta) in enumerate(train_loader):
        if debug:  # visualize groundtruth and predictions
            ...
            for i in range(min(4, inputs.size(0))):
                ...
                tar = target[i].numpy()
                vi = three_view_with_heatmap(inp, tar)
